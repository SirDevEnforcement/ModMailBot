...
class ModMailClient extends Client {
    constructor() {
      ...
      Constants
      */
     this.prefix = "";// Put desired prefix here.
     this.category = "";// Put the category ID that Ticket-Channels will be made in.
     this.role = "";// Role that can access these ModMail tickets.
    }
    commandHandler(path) {
